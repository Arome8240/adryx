...
const ROLES = ["", "advertiser", "publisher", "admin"];
                  ...
                  <tr key={u._id} className="border-b border-white/5 hover:bg-white/2 transition-colors">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-white/30 truncate max-w-[160px]">{u.email ?? "—"}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-5 py-3.5">
                      <select
                        ...
                        className="px-2 py-1 rounded-lg text-xs font-semibold capitalize bg-transparent border border-white/10 outline-none cursor-pointer transition-colors hover:border-white/20"
