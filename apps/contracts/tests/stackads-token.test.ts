...
describe("StackAds Token — SIP-010", () => {
  ...
  describe("metadata", () => {
    it("returns correct name", () => {
      ...
      expect(result).toBeOk(Cl.stringAscii("StackAds Token"));
    });
    ...
    it("returns correct symbol", () => {
      ...
      expect(result).toBeOk(Cl.stringAscii("STAD"));
    });
    ...
    it("returns token URI", () => {
      ...
      expect(result).toBeOk(
        Cl.some(Cl.stringUtf8("https://stackads.io/token-metadata.json")),
      );
    });
  });
